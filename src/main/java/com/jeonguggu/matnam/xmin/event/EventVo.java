...
//	event Search
	private Integer shMnevUseNy;
	private String shMnevTitle;
	private String shMnevContent;
...
public Integer getShMnevUseNy() {
	return shMnevUseNy;
}

public void setShMnevUseNy(Integer shMnevUseNy) {
	this.shMnevUseNy = shMnevUseNy;
}

public String getShMnevTitle() {
	return shMnevTitle;
}

public void setShMnevTitle(String shMnevTitle) {
	this.shMnevTitle = shMnevTitle;
}

public String getShMnevContent() {
	return shMnevContent;
}

public void setShMnevContent(String shMnevContent) {
	this.shMnevContent = shMnevContent;
}
