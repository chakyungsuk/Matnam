							...
							<div class="card" style="height:740px;">
								...
								<div class="card-body h-100">
									...
									<div class="btn_area">
										...
										<button type="button" class="btn btn-outline-secondary"	onclick="location.href='/xmin/memberList';">수정</button>
										<button type="button" class="btn btn-outline-danger"	onclick="location.href='/xmin/memberList';">삭제</button>
									</div>
								</div>
							</div>
						</div>
