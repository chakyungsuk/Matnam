	            ...
	            <div class="col-lg-12">
	                <div class="box_style_2">
	                   ...
	                   <div class="mb-3">
						  ...
						  <textarea class="form-control" id="exampleFormControlTextarea1" name="mnrvText" rows="10" placeholder="서비스 이용시 불편사항에대해 남겨주세요." readonly="readonly"><c:out value="${rtReview.mnrvText}"/></textarea>
						</div>
	                    ...
	                    <div class="button_service_view">
	                    	<div>
		                   		<a href="/user/storeReviewEdit?mnrtSeq=<c:out value="${rtReview.mnrtSeq}"/>&mnMmSeq=<c:out value="${rtReview.mnMmSeq}"/>"><button type="button" class="btn btn-outline-success">수정하기</button></a>
		                   		<a href="/user/storeReviewDele?mnrtSeq=<c:out value="${rtReview.mnrtSeq}"/>&mnMmSeq=<c:out value="${rtReview.mnMmSeq}"/>"><button type="button" class="btn btn-outline-danger">삭제</button></a>
		                   	</div>
		                   	<a href="/user/storeDetail?mnrtSeq=<c:out value="${rtReview.mnrtSeq}"/>"><button type="button" class="btn btn-outline-success">목록</button></a>
	                   	</div>
	                </div><!-- End box_style_1 -->
	            </div>
	        </div><!-- End row -->
