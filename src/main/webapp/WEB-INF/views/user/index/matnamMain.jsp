...
<body>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="detail_page.html" class="strip_list">
                        ...
                        <div class="desc">
                            <div class="thumb_strip">
                                <img src="/resources/user/image/thumb_restaurant.jpg" alt="">
                            </div>
                            <div class="rating">
                    ...
                    <a href="detail_page.html" class="strip_list">
                        ...
                        <div class="desc">
                            <div class="thumb_strip">
                                <img src="/resources/user/image/thumb_restaurant_2.jpg" alt="">
                            </div>
                            <div class="rating">
                                <i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star"></i>
                            </div>
                    ...
                    <a href="detail_page.html" class="strip_list">
                        ...
                        <div class="desc">
                            <div class="thumb_strip">
                                <img src="/resources/user/image/thumb_restaurant_3.jpg" alt="">
                            </div>
                            <div class="rating">
                                <i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star"></i>
                            </div>
                ...
                <div class="col-lg-6">
                    <a href="detail_page.html" class="strip_list">
                        ...
                        <div class="desc">
                            <div class="thumb_strip">
                                <img src="/resources/user/image/thumb_restaurant_4.jpg" alt="">
                            </div>
                            <div class="rating">
                                <i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star"></i>
                            </div>
                    ...
                    <a href="detail_page.html" class="strip_list">
                        ...
                        <div class="desc">
                            <div class="thumb_strip">
                                <img src="/resources/user/image/thumb_restaurant_5.jpg" alt="">
                            </div>
                            <div class="rating">
                                <i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star"></i>
                            </div>
                    ...
                    <a href="detail_page.html" class="strip_list">
                        ...
                        <div class="desc">
                            <div class="thumb_strip">
                                <img src="/resources/user/image/thumb_restaurant_6.jpg" alt="">
                            </div>
                            <div class="rating">
                                <i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star"></i>
                            </div>
    ...
    <section class="parallax-window" data-parallax="scroll" data-image-src="/resources/user/image/bg_office.jpg" data-natural-width="1200" data-natural-height="600">
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <a class="box_work" href="submit_restaurant.html">
                    <img src="/resources/user/image/submit_restaurant.jpg" width="848" height="480" alt="" class="img-fluid">
            ...
            <div class="col-md-5">
                <a class="box_work" href="submit_driver.html">
                    <img src="/resources/user/image/delivery.jpg" width="848" height="480" alt="" class="img-fluid">
